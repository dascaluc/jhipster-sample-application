package com.mycompany.timesheet.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.mycompany.timesheet.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.mycompany.timesheet.repository.UserRepository.USERS_BY_EMAIL_CACHE);
